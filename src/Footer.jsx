  ...
  return (
    <div className="footerContainer">
      <div className="footerbox4" onClick={() => onClickHandler("support")}>
        ...
        {selected == "support" && <div className="underLine3"></div>}
        <div>ヘルプセンター</div>
        <div>安全に関する情報</div>
        <div>キャンセルオプション</div>
      ...
      <div className="footerbox4" onClick={() => onClickHandler("community")}>
        ...
        {selected == "community" && <div className="underLine3"></div>}
      ...
      <div className="footerbox4" onClick={() => onClickHandler("hosting")}>
        ...
        {selected == "hosting" && <div className="underLine3"></div>}
        <div>ホスティングをはじめる</div>
      ...
      <div
        className="footerbox4"
        onClick={() => onClickHandler("companyinformation")}
      >
        <div className="footertitle">企業情報</div>
        {selected == "companyinformation" && <div className="underLine3"></div>}
        <div>ニュースルーム</div>
        <div>新機能のご紹介</div>
